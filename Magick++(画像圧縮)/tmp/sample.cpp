...
//(2025/05)
// --memo--
// 参考サイト:https://ugcj.com/MagickCompressor%E3%83%A9%E3%82%A4%E3%83%96%E3%83%A9%E3%83%AA/#google_vignette
// Unix系OSでの環境構築:https://imageMagickCompressor.org/script/MagickCompressor++.php
//
// 実行時は、PHP側でexec()等を使用します。
// 実行時のcmdの例は[./ImageCompressor input.jpg output.jpg 80]
///////////////////////////////////////////////////////////////////////////////
#include <MagickCompressor++.h>
#include <iostream>
#include <string>

using namespace std;
using namespace MagickCompressor;
...
{   
    ...
    {
        // 初期化
        InitializeMagickCompressor(*argv);
